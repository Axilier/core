...
const Tab = ({ orientation = 'row', showNotSelectedShadow = true, children, onClick, }) => (React__default['default'].createElement(Layout, { center: true, orientation: 'row', className: `${styles$8.tab} ${orientation === 'row' ? styles$8.tabHorizontal : ''}`, onClick: () => {
        if (onClick)
            onClick();
    } },
    children,
