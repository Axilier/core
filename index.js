...
const Google = ({ style, className }) => {
    return (React.createElement("svg", { viewBox: '0 0 18 18', xmlns: 'http://www.w3.org/2000/svg', fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2, style: Object.assign({ width: '20px', height: '20px' }, style), className: className },
