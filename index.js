...
const Button = ({ label, type, variant, onClick, style }) => {
    ...
    return (React.createElement("button", { type: "button", className: "button", style: Object.assign({ border: variant === 'outlined'
...
/** @format */
const Tickbox = ({ ticked, onChange }) => {
    const [isTicked, setIsTicked] = React.useState(ticked);
    React.useEffect(() => setIsTicked(ticked), [ticked]);
    return (React.createElement("svg", { className: 'tick-box', onClick: () => {
            setIsTicked(!isTicked);
            if (!onChange)
                return;
            onChange();
        }, style: {}, viewBox: "0 0 64 64", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 },
...
/** @format */
const Lock = ({ locked, style, disabled, iconColor, onChange }) => {
    const [isLocked, setIsLocked] = React.useState(locked);
    React.useEffect(() => setIsLocked(locked), [locked]);
    return (React.createElement("svg", { style: Object.assign({ height: '20px' }, style), viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2, className: 'lock', onClick: () => {
...
/** @format */
const Room = ({ style }) => {
    return (React.createElement("svg", { viewBox: "0 0 19 19", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2, style: Object.assign({ height: '22px', marginRight: '8px' }, style) },
...
/** @format */
function Mail({ iconColor, style }) {
    return (React.createElement("svg", { viewBox: "0 0 20 17", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2, style: Object.assign({ height: '20px' }, style) },
...
/** @format */
const Key = ({ iconColor, style }) => {
    return (React.createElement("svg", { viewBox: "0 0 21 21", xmlns: "http://www.w3.org/2000/svg", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2, style: Object.assign({ height: '20px' }, style) },
...
/** @format */
const TextBox = ({ label, prefixComponent, suffixComponent, filter, placeholder, size, variant, required, disabled, maxLength, units, onChange, }) => {
    ...
    return (React.createElement("div", { className: 'text-box', style: {
