...
export { Lock, Room, Mail, Key, Google, Github, Warning, Recent, Favourites, SharedFiles, Copyright, Tick, AllFiles, Cross, Issue, Question, Search, } from './components/Icons';
