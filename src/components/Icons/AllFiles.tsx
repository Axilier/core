...
export const AllFiles = ({ style, className, iconColor }: IconProps) => {
    return (
        <svg
            viewBox={'0 0 16 16'}
        ...
        >
            <g fill={iconColor || '#fff'}>
                <path
                    ...
                    fillRule="nonzero"
                />
                <path d="M3.475 5.979H9.97v.767H3.475zM3.475 7.974H9.97v.768H3.475zM3.475 9.966H9.97v.767H3.475z" />
                <path
