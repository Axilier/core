...
export const SharedFiles = ({
    ...
    >
        ...
        <path
            d={
                'M7.811 5.7a1.273 1.273 0 11.264.435L6.009 7.387a1.266 1.266 0 01.027.774l1.982 1.02a1.273 1.273 0 11-.233.452l-1.982-1.02a1.273 1.273 0 11-.057-1.66L7.81 5.7z'
            }
            fill={iconColor || '#fff'}
        />
    </svg>
